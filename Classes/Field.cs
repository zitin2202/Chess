...
namespace Classes
{
    public class Field
    {
        ...
        public Field()
        {
            ...
            {
             { new Rook(new Point(0,0), PlayerSide.Second), new Knight(new Point(0,1),PlayerSide.Second), new Bishop(new Point(0,2),PlayerSide.Second), new King(new Point(0,3),PlayerSide.Second), new Queen(new Point(0,4),PlayerSide.Second), new Bishop(new Point(0,5),PlayerSide.Second), new Knight(new Point(0,6),PlayerSide.Second), new Rook(new Point(0,7),PlayerSide.Second), },
             ...
             { new Rook(new Point(7,0),PlayerSide.First), new Knight(new Point(7,1),PlayerSide.First), new Bishop(new Point(7,2),PlayerSide.First), new King(new Point(7,3),PlayerSide.First), new Queen(new Point(7,4),PlayerSide.First), new Bishop(new Point(7,5),PlayerSide.First), new Knight(new Point(7,6),PlayerSide.First), new Rook(new Point(7,7),PlayerSide.First), },
            };
